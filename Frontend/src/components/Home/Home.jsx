                      ...
                      <div key={ele._id}>
                        <div className="h-auto py-[20px] w-[98vw] sm:w-[250px] lg:w-[300px] bg-[#f1f1f1] shadow-md text-center rounded-md">
                          ...
                          <div className="border-t-2">
                            ...
                            <button
                              className="px-3 py-[5px] text-sm bg-red-600 text-white ml-4 rounded-md mt-[15px]"
                              onClick={() => {
                                addToCart(cartData);
                      ...
                      <div className="h-auto py-[20px]  w-[98%] sm:w-[40%] md:w-[30%] lg:w-[300px] bg-[#f1f1f1] shadow-md text-center rounded-md">
                        ...
                        <div className="border-t-2">
                          ...
                          <button
                            className="px-3 py-[5px] text-sm bg-red-600 text-white ml-4 rounded-md mt-[15px]"
                            onClick={() => {
                              addToCart(cartData).toast.success(
          ...
          {[...Array(Math.ceil(response.length / maxNumber))].map(
            (_, index) => {
              return (
                <button
                  key={index}
                  className={`h-10 w-[80px] shadow-md ${
                    pageNumber === index + 1 ? "bg-[#d4cfcf]" : "bg-[#edebeb]"
                  }`}
                  onClick={() => {
